...
class ShuffleNet(nn.Module):
    def __init__(self, cfg, num_classes=10, co_sponge=1, channel_t=None):
        ...
        if channel_t is not None:
            ...
            ch = out_planes[2]
        self.layer31 = conv_1x1_bn(out_planes[2], ch*co_sponge)
        self.layer32 = conv_1x1_bn(ch*co_sponge, out_planes[2])
