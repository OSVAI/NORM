...
class ShuffleNetV2(nn.Module):
    def __init__(self, net_size, num_classes=10, co_sponge=1, channel_t=None):
        ...
        if channel_t is not None:
            ...
            ch = out_channels[3]
        self.layer31 = conv_1x1_bn(out_channels[3], ch*co_sponge)
        self.layer32 = conv_1x1_bn(ch*co_sponge, out_channels[3])
